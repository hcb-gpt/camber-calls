...
-- Per STRATA directive 2026-01-21
...
comment on function public.decide_lane(public.journal_claims, jsonb)
  is 'Promotion Policy v1 decision function. Normalizes extractor types to policy types. Returns PROMOTE/REVIEW/STAGE + reason_code.';;
