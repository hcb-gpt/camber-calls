-- scan_transcript_for_projects: treat street_name_short as street alias too.
--
-- Fix: street_name_short tokens like "oak" are ultra-common and must require road context.
