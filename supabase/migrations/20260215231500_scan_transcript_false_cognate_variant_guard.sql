-- scan_transcript_for_projects: harden false-cognate filtering for fuzzy paths
-- by filtering both the original token and any generated depluralization variants.
--
-- Motivation:
-- - Some collisions arrive via variants (e.g., "blanks" -> tw_word "blank" -> "Blanton").
