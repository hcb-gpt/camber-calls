-- Fix invalid Postgres regex introduced in 20260215243000.
-- The pattern `(?i:...)` is not supported by Postgres' ARE engine and throws:
--   invalid regular expression: quantifier operand invalid
-- This caused RPC scan_transcript_for_projects to fail at runtime.
