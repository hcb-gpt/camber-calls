-- scan_transcript_for_projects: strip speaker labels before matching and expand
-- the minimal false-cognate list with newly observed collisions.
--
-- Motivation:
-- - Speaker labels (e.g., "Zachary Sittler:") should not count as transcript mentions.
-- - Observed collisions in a 197-call sample:
--   - "christmas" -> "chris" (Skelton Residence) via fuzzy (~0.53)
--   - "permanent" -> "Permar" via fuzzy (~0.51)
